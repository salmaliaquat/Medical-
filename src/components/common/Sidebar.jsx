...
// import {LayoutDashboard, ShoppingCart, CalendarCheck, Users,Stethoscope, Package, PackagePlus, Receipt, FlaskConical, Wallet,BarChart3, UserCog, ShieldCheck, History, Settings} from "lucide-react";
...
//       <div className={`fixed top-0 left-0 h-full w-60 bg-white border-r border-gray-200 shadow-lg z-50 transform transition-transform duration-300
